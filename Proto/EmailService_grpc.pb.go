...
type EmailServiceClient interface {
	SendEmail(ctx context.Context, in *UserInput, opts ...grpc.CallOption) (*EmailResponse, error)
}
...
func (c *emailServiceClient) SendEmail(ctx context.Context, in *UserInput, opts ...grpc.CallOption) (*EmailResponse, error) {
...
type EmailServiceServer interface {
	SendEmail(context.Context, *UserInput) (*EmailResponse, error)
...
func (UnimplementedEmailServiceServer) SendEmail(context.Context, *UserInput) (*EmailResponse, error) {
...
func _EmailService_SendEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmailServiceServer).SendEmail(ctx, req.(*UserInput))
	}
